 ...
 * @author mati
 */
public class borrar_musica extends javax.swing.JFrame {
static Connection coneccion;
static Statement instruccion;
String pass= "sistema";
    /**
     * Creates new form borrar_musica
     */
    public borrar_musica() {
        initComponents();
        setTitle("Borrar Musica");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            instruccion.executeUpdate("delete from musica where ID='"+id.getText()+"'");
            JOptionPane.showMessageDialog(null," s'ha eliminat la musica ");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(borrar_musica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new borrar_musica().setVisible(true);
            }
        });
    }
