 ...
 * @author mati
 */
public class Prestec extends javax.swing.JFrame {
static Connection coneccion;
    static Statement instruccion;
    String pass = "sistema";
    /**
     * Creates new form Prestec
     */
    public Prestec() {
        initComponents();
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        modificar_prestec obj=new modificar_prestec();
        obj.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ResultSet resultado=instruccion.executeQuery("select * FROM prestamo ORDER BY Num_Socio;");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Prestec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
